...
class GoDaddyOAuth(OAuthProvider):
    ...
    def get_user_info(self, access_token: str) -> Dict[str, Any]:
        ...
        response = requests.get(
            "https://api.godaddy.com/v1/user/profile",
            headers=headers
        )
...
class SquarespaceOAuth(OAuthProvider):
    ...
    def get_user_info(self, access_token: str) -> Dict[str, Any]:
        ...
        headers = {"Authorization": f"Bearer {access_token}"}
        response = requests.get(
            "https://api.squarespace.com/1.0/user/profile",
            headers=headers
        )
...
class DomainProviderOAuthManager:
    ...
    def handle_oauth_callback(self, provider: str, code: str, state: str) -> Dict[str, Any]:
        ...
        domain_provider = oauth_provider.create_domain_provider(token_data["access_token"])
