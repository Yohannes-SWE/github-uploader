...
class RenderDeployer:
    ...
    def create_service(self, config: RenderServiceConfig, repo_url: str) -> Dict[str, Any]:
    ...
    def wait_for_deployment(self, service_id: str, deploy_id: str, timeout: int = 600) -> str:
...
class UniversalRenderDeployer:
    ...
    def generate_backend_config(self, app_type: str, project_name: str) -> RenderServiceConfig:
    ...
    def generate_frontend_config(self, app_type: str, project_name: str) -> RenderServiceConfig:
    ...
    def deploy_application(self, repo_url: str, project_name: str, app_config: Dict[str, Any], 
                          custom_env_vars: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        ...
        if app_config.get("backend"):
            backend_config = self.generate_backend_config(app_config["backend"], project_name)
        ...
        if app_config.get("frontend"):
            frontend_config = self.generate_frontend_config(app_config["frontend"], project_name)
            ...
            try:
                ...
                print(f"✅ Frontend service created: {frontend_service['service']['url']}")
            except Exception as e:
    ...
    def deploy_from_github(self, github_repo: str, project_name: Optional[str] = None, 
                          custom_env_vars: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
