...
class DomainProvider(ABC):
    ...
    @abstractmethod
    def update_dns_record(self, domain: str, record_id: str, record: DNSRecord) -> Dict[str, Any]:
...
class GoDaddyProvider(DomainProvider):
    ...
    def update_dns_record(self, domain: str, record_id: str, record: DNSRecord) -> Dict[str, Any]:
        """Update an existing DNS record"""
        return self.add_dns_record(domain, record)  # GoDaddy uses PUT for both add/update
...
class NamecheapProvider(DomainProvider):
    ...
    def get_base_url(self) -> str:
        return "https://api.sandbox.namecheap.com/xml.response"  # Use sandbox for testing
...
class DomainManager:
    ...
    def setup_render_domains(self, provider_name: str, domain: str, render_service_url: str) -> Dict[str, Any]:
    ...
    def setup_fullstack_domains(self, provider_name: str, frontend_domain: str, backend_domain: str, 
                               frontend_url: str, backend_url: str) -> Dict[str, Any]:
        ...
        if frontend_domain:
            ...
            try:
                results["frontend"] = provider.add_dns_record(frontend_domain, frontend_record)
            except Exception as e:
        ...
        if backend_domain:
            ...
            try:
                results["backend"] = provider.add_dns_record(backend_domain, backend_record)
            except Exception as e:
    ...
    def verify_dns_propagation(self, domain: str, expected_value: str, record_type: str = "CNAME") -> bool:
...
# Provider factory
def create_provider(provider_type: str, api_key: str, api_secret: str = None) -> DomainProvider:
